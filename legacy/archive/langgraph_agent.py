"""Archived LangGraph-based agent implementation.

This file preserves the original V2 prototype for reference. The maintained
implementation lives in :mod:`v2.agent.core.agent`.
"""
