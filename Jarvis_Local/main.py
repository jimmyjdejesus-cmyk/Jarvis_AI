...
class ChatApplication(Frame):
    """Simple chat UI that interacts with the orchestrator."""
    ...
    def send_message_event(self, event):
        """Callback for pressing Return in the entry box."""
        self.send_message()

    def send_message(self):
        """Handle user input and trigger agent response."""
    ...
    def get_agent_response(self, user_input):
        """Fetch response from orchestrator and update UI."""
